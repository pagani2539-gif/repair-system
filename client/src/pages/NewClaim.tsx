    ...
    <div className="new-repair-page">
      <div className="page-header">
        <div className="page-title">
          ...
          <p>กรอกรายละเอียดการเคลมอุปกรณ์ที่ต้องการส่งเข้าศูนย์บริการ</p>
        </div>
      </div>
      ...
      <div className="card" style={{ maxWidth: '900px', margin: '0 auto' }}>
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-grid">
            <div className="form-group">
              <label><Laptop size={16} color="var(--primary)" /> ชื่ออุปกรณ์ / รุ่น (เพื่อการเคลม)</label>
              <input 
                type="text" 
                required 
            ...
            <div className="form-group">
              ...
              <input 
                type="text" 
                required 
                placeholder="เช่น ห้องประชุมชั้น 2, แผนกไอที"
          ...
          <div className="form-group">
            <label><AlertCircle size={16} color="var(--primary)" /> เหตุผลการเคลม / อาการเสีย</label>
            <textarea 
              required 
              rows={4}
          ...
          <div className="form-group">
            <label><FileText size={16} color="var(--primary)" /> รูปภาพหลักฐานการเคลม (สูงสุด 2 รูป)</label>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '1.5rem', marginTop: '2.5rem' }}>
            ...
            <button type="submit" className="btn btn-primary" disabled={loading} style={{ padding: '12px 50px', fontSize: '1rem' }}>
              {loading ? 'กำลังบันทึกข้อมูล...' : 'ส่งข้อมูลเคลม'}
            </button>
          </div>
        </form>
      </div>
